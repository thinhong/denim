...
Similar to `deSolve`, `denim` also ask the users to provide the [initial values]{.underline} and any [additional parameters]{.underline} in the form of named vectors.
